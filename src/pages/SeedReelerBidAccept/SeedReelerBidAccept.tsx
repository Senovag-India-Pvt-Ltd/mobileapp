import { IonAlert, IonButton,IonDatetime, IonButtons, IonCol, IonContent, IonGrid, IonHeader, IonInput, IonItem, IonLabel, IonMenuButton, IonPage, IonRow, IonSegment, IonSegmentButton, IonTitle, IonToolbar, useIonViewDidEnter, useIonViewWillEnter } from '@ionic/react';
...
const SeedReelerBidAccept: React.FC = () => {
  ...
  const fetchHighestBidDetails = () => {
    ...
    api.post("market-auction/v1/auction/seedMarketAuction/getHighestBidPerLotDetails", fetchHighestBidPayload, {
      headers: {
  ...
  const handleAcceptButtonEvent = () => {
    ...
    api.post("market-auction/v1/auction/seedMarketAuction/acceptReelerBidForGivenLot", acceptBidPayLoad, {
      headers: {
        "Content-Type": "application/json",
        accept: "*/*",
        Authorization: `Bearer ${localStorage.getItem("jwtToken")}`,
  ...
  const handleRejectButtonEvent = () => {
    ...
    api.post("market-auction/v1/auction/seedMarketAuction/rejectReelerBidForGivenLot", rejectBidPayLoad, {
      headers: {
        "Content-Type": "application/json",
        accept: "*/*",
        Authorization: `Bearer ${localStorage.getItem("jwtToken")}`,
...
export default SeedReelerBidAccept;
