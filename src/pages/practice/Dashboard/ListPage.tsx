                ...
                <IonCard className="card" >
                  ...
                  {viewIndex === index && (
                    <IonCardContent>
                      ...
                      <IonLabel><IonIcon icon={cash} /><b>Eligible Subsidy:</b> {item.schemeAmount}</IonLabel><br />
                      {/* <IonLabel><IonIcon icon={cash} /> <b>Eligible subsidy:</b> {item.eligibleSubsidy}</IonLabel><br /> */}
